...
earth.getMaterial().setDoubleFace(1)
earth.getMaterial().setProgram("textured")
...
light1.setColor(Color(0.1, 0.1, 0.1, 1.0))
...
light2.setColor(Color(0.2, 0.2, 0.4, 1.0))
